...
public class PulsRadioPlayer extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //set up dialog
        dialog = new Dialog(PulsRadioPlayer.this);
	...
	*/
	...
	private void triggerNotification(boolean create, String chan_title, String chan_descr) {
    	if (create == true) {
    		CharSequence title = chan_title;
            CharSequence message = chan_descr;
            
    		notificationManager = (NotificationManager) getSystemService(NOTIFICATION_SERVICE);
    		Notification notification = new Notification(R.drawable.icon, getString(R.string.notifi_execution), 0);
    		
    		Intent notificationIntent = new Intent(this, PulsRadioPlayer.class);
    		PendingIntent pendingIntent = PendingIntent.getActivity(this, 0, notificationIntent, 0);
    		
            notification.setLatestEventInfo(PulsRadioPlayer.this, title, message, pendingIntent);
